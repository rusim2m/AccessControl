...
export const assignCard = (id, employeeId) =>
  api.put(`/client/cards/${id}/assign`, { employeeId })
...
export const getClientAccessLogs = (params) =>
  api.get('/client/access-logs', { params })
